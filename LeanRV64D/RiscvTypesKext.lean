...
def aes_decode_rcon (r : (BitVec 4)) : SailM (BitVec 32) := do
  ...
  match_bv r with
  | 0000 => do (pure (0x00000001 : (BitVec 32)))
  | 0001 => do (pure (0x00000002 : (BitVec 32)))
  | 0010 => do (pure (0x00000004 : (BitVec 32)))
  | 0011 => do (pure (0x00000008 : (BitVec 32)))
  | 0100 => do (pure (0x00000010 : (BitVec 32)))
  | 0101 => do (pure (0x00000020 : (BitVec 32)))
  | 0110 => do (pure (0x00000040 : (BitVec 32)))
  | 0111 => do (pure (0x00000080 : (BitVec 32)))
  | 1000 => do (pure (0x0000001B : (BitVec 32)))
  | 1001 => do (pure (0x00000036 : (BitVec 32)))
  | _ => do (internal_error "riscv_types_kext.sail" 99 "Unexpected AES r")
