...
/-- Type quantifiers: k_ex284115# : Bool, k_ex284114# : Bool, k_ex284113# : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex284161# : Bool, k_ex284160# : Bool, k_ex284159# : Bool, width : Nat, width
  ∈ {1, 2, 4, 8} ∧ width ≤ xlen_bytes ∨ width ≤ flen_bytes -/
...
/-- Type quantifiers: k_ex284191# : Bool, k_ex284190# : Bool, k_ex284189# : Bool, width : Nat, width
  ∈ {1, 2, 4, 8} ∧ width ≤ xlen_bytes ∨ width ≤ flen_bytes -/
