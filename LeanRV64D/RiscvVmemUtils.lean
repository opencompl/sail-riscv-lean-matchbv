...
/-- Type quantifiers: k_ex351678# : Bool, k_ex351677# : Bool, k_ex351676# : Bool, width : Nat, width
  ∈ {1, 2, 4, 8} ∧ width ≤ xlen_bytes ∨ width ≤ flen_bytes -/
...
/-- Type quantifiers: k_ex351708# : Bool, k_ex351707# : Bool, k_ex351706# : Bool, width : Nat, width
  ∈ {1, 2, 4, 8} ∧ width ≤ xlen_bytes ∨ width ≤ flen_bytes -/
