...
/-- Type quantifiers: k_ex351362# : Bool, level : Nat, k_ex351360# : Bool, k_ex351359# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex351407# : Bool, k_ex351406# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex351431# : Bool, k_ex351430# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex351470# : Bool, k_ex351469# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
