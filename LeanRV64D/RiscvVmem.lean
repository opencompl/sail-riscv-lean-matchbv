...
/-- Type quantifiers: k_ex351401# : Bool, level : Nat, k_ex351399# : Bool, k_ex351398# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex351446# : Bool, k_ex351445# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex351509# : Bool, k_ex351508# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
