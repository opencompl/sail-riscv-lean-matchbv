...
/-- Type quantifiers: k_ex283916# : Bool, level : Nat, k_ex283914# : Bool, k_ex283913# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex283961# : Bool, k_ex283960# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex283985# : Bool, k_ex283984# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex284024# : Bool, k_ex284023# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
