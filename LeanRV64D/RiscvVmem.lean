...
/-- Type quantifiers: k_ex283894# : Bool, level : Nat, k_ex283892# : Bool, k_ex283891# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex283939# : Bool, k_ex283938# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex283963# : Bool, k_ex283962# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex284002# : Bool, k_ex284001# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
