...
/-- Type quantifiers: k_ex346454# : Bool, level : Nat, k_ex346452# : Bool, k_ex346451# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex346499# : Bool, k_ex346498# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex346523# : Bool, k_ex346522# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex346562# : Bool, k_ex346561# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
