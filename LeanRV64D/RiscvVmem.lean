...
/-- Type quantifiers: k_ex319965# : Bool, level : Nat, k_ex319963# : Bool, k_ex319962# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex320029# : Bool, k_ex320028# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex320053# : Bool, k_ex320052# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex320096# : Bool, k_ex320095# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
