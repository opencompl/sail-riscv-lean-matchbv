...
/-- Type quantifiers: k_ex323301# : Bool, level : Nat, k_ex323299# : Bool, k_ex323298# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex323365# : Bool, k_ex323364# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex323389# : Bool, k_ex323388# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex323432# : Bool, k_ex323431# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
