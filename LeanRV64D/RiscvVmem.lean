...
/-- Type quantifiers: k_ex283906# : Bool, level : Nat, k_ex283904# : Bool, k_ex283903# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex283951# : Bool, k_ex283950# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex283975# : Bool, k_ex283974# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex284014# : Bool, k_ex284013# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
