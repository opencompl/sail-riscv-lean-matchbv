...
/-- Type quantifiers: k_ex351638# : Bool, level : Nat, k_ex351636# : Bool, k_ex351635# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex351683# : Bool, k_ex351682# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex351707# : Bool, k_ex351706# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex351746# : Bool, k_ex351745# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
