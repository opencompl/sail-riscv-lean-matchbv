...
/-- Type quantifiers: k_ex323295# : Bool, level : Nat, k_ex323293# : Bool, k_ex323292# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex323359# : Bool, k_ex323358# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex323383# : Bool, k_ex323382# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex323426# : Bool, k_ex323425# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
