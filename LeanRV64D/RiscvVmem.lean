...
/-- Type quantifiers: k_ex346468# : Bool, level : Nat, k_ex346466# : Bool, k_ex346465# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex346513# : Bool, k_ex346512# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex346537# : Bool, k_ex346536# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex346576# : Bool, k_ex346575# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
