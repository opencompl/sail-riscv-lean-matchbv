...
/-- Type quantifiers: k_ex319753# : Bool, level : Nat, k_ex319751# : Bool, k_ex319750# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex319817# : Bool, k_ex319816# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex319841# : Bool, k_ex319840# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex319884# : Bool, k_ex319883# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
