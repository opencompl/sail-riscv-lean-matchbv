...
def fsplit_D (x64 : (BitVec 64)) : ((BitVec 1) × (BitVec 11) × (BitVec 52)) :=
  let t__3822 := (Sail.BitVec.extractLsb x64 63 63)
  let t__3823 := (Sail.BitVec.extractLsb x64 62 52)
  let t__3824 := (Sail.BitVec.extractLsb x64 51 0)
  (t__3822, t__3823, t__3824)
...
/-- Type quantifiers: k_ex317888# : Bool -/
...
/-- Type quantifiers: k_ex317956# : Bool -/
