...
def fcvtmod_helper (x64 : (BitVec 64)) : ((BitVec 5) × (BitVec 32)) :=
  ...
  if is_zero
  then
    let t__3785 := (zeros_implicit (n := 5))
    let t__3786 := (zeros_implicit (n := 32))
    (t__3785, t__3786)
  else
    if is_subnorm
    then
      let t__3783 := (nxFlag ())
      let t__3784 := (zeros_implicit (n := 32))
      (t__3783, t__3784)
    else
      if is_nan_or_inf
      then
        let t__3781 := (nvFlag ())
        let t__3782 := (zeros_implicit (n := 32))
        (t__3781, t__3782)
      else
        if is_too_large
        then
          let t__3779 := (nvFlag ())
          let t__3780 := (zeros_implicit (n := 32))
          (t__3779, t__3780)
        else
          if is_too_small
          then
            let t__3777 := (nxFlag ())
            let t__3778 := (zeros_implicit (n := 32))
            (t__3777, t__3778)
          else
