...
/-- Type quantifiers: k_ex312896# : Bool, level : Nat, k_ex312894# : Bool, k_ex312893# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex312960# : Bool, k_ex312959# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex312984# : Bool, k_ex312983# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex313027# : Bool, k_ex313026# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
