...
/-- Type quantifiers: k_ex312808# : Bool, level : Nat, k_ex312806# : Bool, k_ex312805# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex312872# : Bool, k_ex312871# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex312896# : Bool, k_ex312895# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex312939# : Bool, k_ex312938# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
