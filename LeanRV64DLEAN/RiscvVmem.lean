...
/-- Type quantifiers: k_ex312320# : Bool, level : Nat, k_ex312318# : Bool, k_ex312317# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex312384# : Bool, k_ex312383# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex312408# : Bool, k_ex312407# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex312451# : Bool, k_ex312450# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
