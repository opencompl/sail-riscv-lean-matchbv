...
/-- Type quantifiers: k_ex319363# : Bool, level : Nat, k_ex319361# : Bool, k_ex319360# : Bool, sv_width
...
/-- Type quantifiers: tlb_index : Nat, k_ex319427# : Bool, k_ex319426# : Bool, sv_width : Nat, is_sv_mode(sv_width), 0
...
/-- Type quantifiers: k_ex319451# : Bool, k_ex319450# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
...
/-- Type quantifiers: k_ex319494# : Bool, k_ex319493# : Bool, sv_width : Nat, is_sv_mode(sv_width) -/
