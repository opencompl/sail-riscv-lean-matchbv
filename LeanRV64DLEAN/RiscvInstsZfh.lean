...
def fsplit_H (xf16 : (BitVec 16)) : ((BitVec 1) × (BitVec 5) × (BitVec 10)) :=
  let t__3752 := (Sail.BitVec.extractLsb xf16 15 15)
  let t__3753 := (Sail.BitVec.extractLsb xf16 14 10)
  let t__3754 := (Sail.BitVec.extractLsb xf16 9 0)
  (t__3752, t__3753, t__3754)
...
/-- Type quantifiers: k_ex314853# : Bool -/
